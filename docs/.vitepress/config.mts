        ...
        items: [
          {
            ...
            collapsed: true,
            items: [
              { text: '投资基础', link: '/appendix/reading-list#投资基础' },
              { text: '行为金融与心理学', link: '/appendix/reading-list#行为金融与心理学' },
              { text: 'FIRE 相关', link: '/appendix/reading-list#fire-相关' },
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: '数据源', link: '/appendix/tools#数据源' },
              { text: '工具', link: '/appendix/tools#工具' },
              { text: '我的日常流程', link: '/appendix/tools#我的日常流程' },
            ],
          },
        ],
      },
